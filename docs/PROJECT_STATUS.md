...
- **Task 2 — the app catalog.** 88 apps, ~38% social by design. See [APP_CATALOG.md](APP_CATALOG.md) for why it is deliberately partial and what in it is still unverified.

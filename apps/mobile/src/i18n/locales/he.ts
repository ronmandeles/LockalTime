...
export const he: TranslationSchema = {
  ...
  createSession: {
    ...
    blocklist: {
      ...
      appCount: '{{count}} ברשימה',
      showApps: 'הצגת האפליקציות בקטגוריה הזו',
      hideApps: 'הסתרת האפליקציות בקטגוריה הזו',
      categoryAppsNote:
        'האפליקציות שאנחנו יודעים לנקוב בשמן בקטגוריה הזו. היא חוסמת גם כאלה שאינן ברשימה.',
      categoryCoveredNote: 'הקטגוריה הזו מסומנת, ולכן כולן ייחסמו בין אם תסמנו אותן ובין אם לא.',
